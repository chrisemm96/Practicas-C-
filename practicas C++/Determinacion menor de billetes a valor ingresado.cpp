/*8. Escribir una función nombrada cambio() que tenga un párametro en un número entero
y seis parametros de referencia en número entero nombrado cien, cincuenta, veinte,
diez, cinco y uno, respectivamente.
La función tiene que considerar el valor entero transmitido como una cantidad en dólares 
